  ...
  return (
    <div className="w-[100%]   px-6">
      ...
      <div className="grid gap-4 grid-cols-[repeat(auto-fit,_minmax(100px,_1fr))] ">
        {skills.map(({ name, img }, ind) => {
          return (
            <div
              key={ind + name}
              className="group cursor-pointer  relative h-40 w-full dark:bg-gray-900 bg-gray-200 border-2 border-primary rounded-3xl flex justify-center items-center flex-col gap-1 dark:text-secondary"
            >
