...
#### We just had to add some addEventListener to the document to listen to the scroll event and call the function scrolled which will calculate the scroll progress and set the width of the progress bar accordingly
